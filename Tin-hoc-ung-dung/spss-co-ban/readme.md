...
- Kết luận: _Theo `Pearson Chi-square` có p = `Asymptotic Significance (2-sided)` = .000 < 0.05 nên có sự liên hệ tỷ lệ hài lòng ở cán bộ y tế giữa các tỉnh/thành phố._ Đây là bảng `n×m` nên đọc p ở hàng thứ nhất, nếu là bảng `2×2` thì đọc p ở hàng thứ hai.
